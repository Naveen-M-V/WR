...
const Industrial = () => {
  ...
  const allListings = listings.concat(
    backendCompanies
      .filter((c) => c.mainSector === 'Industrial' || (c.industrySector && c.industrySector.includes('Industrial')))
      .map((c) => ({
        id: c.id,
        slug: c.slug,
        title: c.companyName,
    ...
    <div ref={containerRef} className="min-h-screen text-white overflow-hidden" style={{ background: "#040e1e" }}>
      ...
      >
        <div
          className="absolute inset-0"
          style={{
            backgroundImage: "url('/sectors/Industrial.jpg')",
        ...
        >
          ...
          >
            Powering industry with renewable energy solutions that cut operational costs, enhance sustainability, and drive manufacturing efficiency.
          </motion.p>
          <motion.button
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 pt-20 pb-6">
        ...
        >
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "clamp(14px, 1.5vw, 16px)", color: "rgba(255,255,255,0.5)", lineHeight: 1.85, fontWeight: 300 }}>
            <span style={{ color: "#10b981", fontWeight: 500 }}>Industry is embracing renewable energy solutions</span> to cut energy costs, increase independence, and reduce carbon footprints. From large-scale solar installations and wind farms to battery storage and microgrids, clean technologies are transforming the way industrial facilities generate and consume power. Check out some of the UK and Ireland's movers and shakers in the supply of market leading industrial products and services.
          </p>
        </motion.div>
      </div>
